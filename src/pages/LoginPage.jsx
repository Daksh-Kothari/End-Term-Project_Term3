      ...
      <div className="hidden lg:flex lg:w-1/2 animated-gradient relative items-center justify-center p-12">
        <div className="relative z-10 text-center text-white">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}>
            ...
            <h2 className="text-3xl font-bold mb-3">{APP_NAME}</h2>
            <p className="text-white/80 text-lg">Your intelligent study companion</p>
          </motion.div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-white dark:bg-surface-950">
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <p className="text-surface-500 mt-1">Sign in to continue studying</p>
          </div>
          <LoginForm />
        </div>
      </div>
